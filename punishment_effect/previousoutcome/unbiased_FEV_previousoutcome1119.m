load('L:\Monkey1\region1\20211119\stim_markers_cue_previouscorrectwrongcurrenttrialcon1con2_20211119.mat');
...
iscell=readNPY('L:\4subregions\subregion1_11_18_11_19_11_22\subregion1\suite2p\plane0\iscell.npy');
...
for i=1:length(unbiased_saccaderight_previous_wrongcorrect)
    ...
    unbiased_previousoutcome1119(i,j)=mean([unbiased_saccadeleft_previous_wrongcorrect(i,j),unbiased_saccaderight_previous_wrongcorrect(i,j)]);
    end
end

save('L:\thesis\manual_recircle_same_neurons_4_different_subregions\subregion1_suite2p_automatically\20211119\unbiased_previousoutcome1119_sameneurons.mat','unbiased_previousoutcome1119');
