...
%load('D:\ZY_lab\Monkey\M180519\subregion1_11_18_11_19_11_22\20211126\s1125_shared.mat');
%s=s1125_shared;
%F_raw=F_divide.day1;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%each_frame
for cell_num=1:length(s)
M1region1day1mean_ratio_deltaF_correct.(sprintf('cell_%d_con_1',s(cell_num)))=ratio_deltaF.(sprintf('cell_%d_con_1',s(cell_num)));
M1region1day1mean_ratio_deltaF_correct.(sprintf('cell_%d_con_2',s(cell_num)))=ratio_deltaF.(sprintf('cell_%d_con_2',s(cell_num)));
M1region1day1mean_ratio_deltaF_wrong.(sprintf('cell_%d_con_1',s(cell_num)))=ratio_deltaF_wrong.(sprintf('cell_%d_con_1',s(cell_num)));
M1region1day1mean_ratio_deltaF_wrong.(sprintf('cell_%d_con_2',s(cell_num)))=ratio_deltaF_wrong.(sprintf('cell_%d_con_2',s(cell_num)));
end

for cell_num=1:length(s)
M1region1day1_ratio_deltaF_correctintegration.(sprintf('cell_%d',s(cell_num)))=[M1region1day1mean_ratio_deltaF_correct.(sprintf('cell_%d_con_1',s(cell_num)));M1region1day1mean_ratio_deltaF_correct.(sprintf('cell_%d_con_2',s(cell_num)))];
M1region1day1_ratio_deltaF_wrongintegration.(sprintf('cell_%d',s(cell_num)))=[M1region1day1mean_ratio_deltaF_wrong.(sprintf('cell_%d_con_1',s(cell_num)));M1region1day1mean_ratio_deltaF_wrong.(sprintf('cell_%d_con_2',s(cell_num)))];
end
for cell_num=1:length(s)
M1region1day1_mean_ratio_deltaF_correctintegration.(sprintf('cell_%d',s(cell_num)))=mean([M1region1day1mean_ratio_deltaF_correct.(sprintf('cell_%d_con_1',s(cell_num)));M1region1day1mean_ratio_deltaF_correct.(sprintf('cell_%d_con_2',s(cell_num)))],1);
M1region1day1_mean_ratio_deltaF_wrongintegration.(sprintf('cell_%d',s(cell_num)))=mean([M1region1day1mean_ratio_deltaF_wrong.(sprintf('cell_%d_con_1',s(cell_num)));M1region1day1mean_ratio_deltaF_wrong.(sprintf('cell_%d_con_2',s(cell_num)))],1);
end

M1region1day1_difference=[];
for cell_num=1:length(s)
    M1region1day1_difference(cell_num,:)=M1region1day1_mean_ratio_deltaF_correctintegration.(sprintf('cell_%d',s(cell_num)))-M1region1day1_mean_ratio_deltaF_wrongintegration.(sprintf('cell_%d',s(cell_num)));
end
...
markers = 'L:\Monkey1\region1\20211108\judge_the_types_of_neurons_on_each_frame_20211108.mat';
save(markers,'M1region1day1_difference');
